...
public class DialogueEvents
{
    ...
    public event Action<Story, string, List<Choice>> onDisplayDialogue;
    public void DisplayDialogue(Story currentStory, string dialogueLine, List<Choice> dialogueChoices) 
    {
        if (onDisplayDialogue != null) 
        {
            onDisplayDialogue(currentStory, dialogueLine, dialogueChoices);
        }
    }
